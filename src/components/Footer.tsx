        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Cryptoshaft Mining is one of the leading cryptocurrency mining platforms, offering cryptocurrency mining capacities in every range - for newcomers. Our mission is to make acquiring cryptocurrencies easy and fast for everyone.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:support@cryptoshaftmining.com" className="text-white/70 hover:text-yellow-400 transition-colors">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-white/70 text-sm text-center">
              Copyright © 2020-2025 Cryptoshaft Mining All Right Reserved
            </p>
          </div>
        </div>
      </div>
